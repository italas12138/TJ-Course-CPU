...
set rc [catch {
  ...
  set_property ip_repo_paths d:/My_31CPU_post/My_31CPU_post.cache/ip [current_project]
  set_property ip_output_repo d:/My_31CPU_post/My_31CPU_post.cache/ip [current_project]
  add_files -quiet D:/My_31CPU_post/My_31CPU_post.runs/synth_1/sccomp_dataflow.dcp
  add_files -quiet D:/My_31CPU_post/My_31CPU_post.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0.dcp
  set_property netlist_only true [get_files D:/My_31CPU_post/My_31CPU_post.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0.dcp]
  read_xdc -mode out_of_context -ref dist_mem_gen_0 -cells U0 d:/My_31CPU_post/My_31CPU_post.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_ooc.xdc
  set_property processing_order EARLY [get_files d:/My_31CPU_post/My_31CPU_post.srcs/sources_1/ip/dist_mem_gen_0/dist_mem_gen_0_ooc.xdc]
